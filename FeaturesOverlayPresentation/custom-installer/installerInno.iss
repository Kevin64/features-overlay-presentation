...
Source: ".\Release\Newtonsoft.Json.Bson.dll"; DestDir: "{commonpf32}\{#MyAppName}"; Flags: ignoreversion
...
Source: ".\Release\RestApi.dll"; DestDir: "{commonpf32}\{#MyAppName}"; Flags: ignoreversion
...
Source: ".\Release\System.Net.Http.Formatting.dll"; DestDir: "{commonpf32}\{#MyAppName}"; Flags: ignoreversion
...
Source: ".\Release\System.Threading.Tasks.Extensions.dll"; DestDir: "{commonpf32}\{#MyAppName}"; Flags: ignoreversion

Source: ".\Release\RestApi.dll.config"; DestDir: "{commonpf32}\{#MyAppName}"; Flags: ignoreversion
...
Source: ".\Release\config.json"; DestDir: "{commonpf32}\{#MyAppName}"; Flags: ignoreversion
